...
data = pd.read_csv('./时序数据库调研/WorldQuant 101 Alpha 因子指标库/db/dataPerformance.csv')
...
timeRes.to_csv('./时序数据库调研/WorldQuant 101 Alpha 因子指标库/res/pyPerformance.txt',index=False)
# print(timeRes)
